...
const char *SimulationBeginEntry::getAsString(const char *attribute) const
{
    ...
    {
        snprintf(buffer, sizeof(buffer), "%d", omnetppVersion);
        return buffer;
    }
    else if (!strcmp(attribute, "ev"))
    {
        snprintf(buffer, sizeof(buffer), "%d", eventlogVersion);
        return buffer;
    }
...
const char *SimulationEndEntry::getAsString(const char *attribute) const
{
    ...
    {
        snprintf(buffer, sizeof(buffer), "%d", isError);
        return buffer;
    }
    else if (!strcmp(attribute, "c"))
    {
        snprintf(buffer, sizeof(buffer), "%d", resultCode);
        return buffer;
    }
...
const char *EventEntry::getAsString(const char *attribute) const
{
    ...
    {
        snprintf(buffer, sizeof(buffer), "%" EVENTNUMBER_PRINTF_FORMAT "", eventNumber);
        return buffer;
    }
    ...
    {
        snprintf(buffer, sizeof(buffer), "%d", moduleId);
        return buffer;
    }
    else if (!strcmp(attribute, "ce"))
    {
        snprintf(buffer, sizeof(buffer), "%" EVENTNUMBER_PRINTF_FORMAT "", causeEventNumber);
        return buffer;
    }
    else if (!strcmp(attribute, "msg"))
    {
        snprintf(buffer, sizeof(buffer), "%" MSGID_PRINTF_FORMAT "", messageId);
        return buffer;
    }
...
const char *SnapshotEntry::getAsString(const char *attribute) const
{
    ...
    {
        snprintf(buffer, sizeof(buffer), "%" PRId64 "", fileOffset);
        return buffer;
    }
    else if (!strcmp(attribute, "#"))
    {
...
const char *IndexEntry::getAsString(const char *attribute) const
{
    ...
    {
        snprintf(buffer, sizeof(buffer), "%" PRId64 "", previousIndexFileOffset);
        return buffer;
    }
    else if (!strcmp(attribute, "s"))
    {
        snprintf(buffer, sizeof(buffer), "%" PRId64 "", previousSnapshotFileOffset);
        return buffer;
    }
    else if (!strcmp(attribute, "#"))
    {
...
const char *ReferenceEntry::getAsString(const char *attribute) const
{
    ...
    {
        snprintf(buffer, sizeof(buffer), "%d", beginEntryIndex);
        return buffer;
    }
    else if (!strcmp(attribute, "e"))
    {
        snprintf(buffer, sizeof(buffer), "%d", endEntryIndex);
        return buffer;
    }
    else
        return nullptr;
...
const char *GateReferenceEntry::getAsString(const char *attribute) const
{
    ...
    {
        snprintf(buffer, sizeof(buffer), "%d", gateId);
        return buffer;
    }
    else
        return nullptr;
...
const char *ConnectionReferenceEntry::getAsString(const char *attribute) const
{
    ...
    {
        snprintf(buffer, sizeof(buffer), "%d", sourceModuleId);
        return buffer;
    }
    else if (!strcmp(attribute, "sg"))
    {
        snprintf(buffer, sizeof(buffer), "%d", sourceGateId);
        return buffer;
    }
    else
        return nullptr;
...
const char *ModuleDescriptionEntry::getAsString(const char *attribute) const
{
    ...
    {
        snprintf(buffer, sizeof(buffer), "%d", parentModuleId);
        return buffer;
    }
    ...
    {
        snprintf(buffer, sizeof(buffer), "%d", compoundModule);
        return buffer;
    }
    else
...
const char *GateDescriptionEntry::getAsString(const char *attribute) const
{
    ...
    {
        snprintf(buffer, sizeof(buffer), "%d", isOutput);
        return buffer;
    }
    else
...
const char *ConnectionDescriptionEntry::getAsString(const char *attribute) const
{
    ...
    {
        snprintf(buffer, sizeof(buffer), "%d", destModuleId);
        return buffer;
    }
    else if (!strcmp(attribute, "dg"))
    {
        snprintf(buffer, sizeof(buffer), "%d", destGateId);
        return buffer;
    }
    else
...
const char *MessageDescriptionEntry::getAsString(const char *attribute) const
{
    ...
    {
        snprintf(buffer, sizeof(buffer), "%" MSGID_PRINTF_FORMAT "", messageTreeId);
        return buffer;
    }
    else if (!strcmp(attribute, "eid"))
    {
        snprintf(buffer, sizeof(buffer), "%" MSGID_PRINTF_FORMAT "", messageEncapsulationId);
        return buffer;
    }
    else if (!strcmp(attribute, "etid"))
    {
        snprintf(buffer, sizeof(buffer), "%" MSGID_PRINTF_FORMAT "", messageEncapsulationTreeId);
        return buffer;
    }
    else if (!strcmp(attribute, "c"))
    ...
    {
        snprintf(buffer, sizeof(buffer), "%d", messageKind);
        return buffer;
    }
    else if (!strcmp(attribute, "p"))
    {
        snprintf(buffer, sizeof(buffer), "%d", messagePriority);
        return buffer;
    }
    else if (!strcmp(attribute, "l"))
    {
        snprintf(buffer, sizeof(buffer), "%" PRId64 "", messageLength);
        return buffer;
    }
    else if (!strcmp(attribute, "er"))
    {
        snprintf(buffer, sizeof(buffer), "%d", hasBitError);
        return buffer;
    }
    else if (!strcmp(attribute, "m"))
    {
        snprintf(buffer, sizeof(buffer), "%d", ownerModuleId);
        return buffer;
    }
    else if (!strcmp(attribute, "sm"))
    {
        snprintf(buffer, sizeof(buffer), "%d", senderModuleId);
        return buffer;
    }
    else if (!strcmp(attribute, "sg"))
    {
        snprintf(buffer, sizeof(buffer), "%d", senderGateId);
        return buffer;
    }
    ...
    {
        snprintf(buffer, sizeof(buffer), "%d", arrivalModuleId);
        return buffer;
    }
    else if (!strcmp(attribute, "ag"))
    {
        snprintf(buffer, sizeof(buffer), "%d", arrivalGateId);
        return buffer;
    }
    ...
    {
        snprintf(buffer, sizeof(buffer), "%" EVENTNUMBER_PRINTF_FORMAT "", previousEventNumber);
        return buffer;
    }
    else
...
const char *ComponentMethodBeginEntry::getAsString(const char *attribute) const
{
    ...
    {
        snprintf(buffer, sizeof(buffer), "%d", sourceComponentId);
        return buffer;
    }
    else if (!strcmp(attribute, "tm"))
    {
        snprintf(buffer, sizeof(buffer), "%d", targetComponentId);
        return buffer;
    }
    else if (!strcmp(attribute, "m"))
        return methodName;
...
const char *CloneMessageEntry::getAsString(const char *attribute) const
{
    ...
    {
        snprintf(buffer, sizeof(buffer), "%" MSGID_PRINTF_FORMAT "", cloneId);
        return buffer;
    }
    else
        return MessageDescriptionEntry::getAsString(attribute);
...
const char *EncapsulatePacketEntry::getAsString(const char *attribute) const
{
    ...
    {
        snprintf(buffer, sizeof(buffer), "%" MSGID_PRINTF_FORMAT "", encapsulatedPacketId);
        return buffer;
    }
    else
        return MessageReferenceEntry::getAsString(attribute);
...
const char *BeginSendEntry::getAsString(const char *attribute) const
{
    ...
    {
        snprintf(buffer, sizeof(buffer), "%d", isUpdate);
        return buffer;
    }
    else if (!strcmp(attribute, "tx"))
    {
        snprintf(buffer, sizeof(buffer), "%" TXID_PRINTF_FORMAT "", transmissionId);
        return buffer;
    }
    else
        return MessageDescriptionEntry::getAsString(attribute);
...
const char *EndSendEntry::getAsString(const char *attribute) const
{
    ...
    {
        snprintf(buffer, sizeof(buffer), "%d", isDeliveredImmediately);
        return buffer;
    }
    else
        return MessageDescriptionEntry::getAsString(attribute);
...
const char *SendHopEntry::getAsString(const char *attribute) const
{
    ...
    {
        snprintf(buffer, sizeof(buffer), "%d", discard);
        return buffer;
    }
    else
        return nullptr;
...
const char *ModuleFoundEntry::getAsString(const char *attribute) const
{
    ...
    {
        snprintf(buffer, sizeof(buffer), "%" EVENTNUMBER_PRINTF_FORMAT "", lastSeenEventNumber);
        return buffer;
    }
    else if (!strcmp(attribute, "ei"))
    {
        snprintf(buffer, sizeof(buffer), "%d", lastSeenEntryIndex);
        return buffer;
    }
    else
        return ModuleDescriptionEntry::getAsString(attribute);
...
const char *CustomReferenceEntry::getAsString(const char *attribute) const
{
    ...
    {
        snprintf(buffer, sizeof(buffer), "%ld", key);
        return buffer;
    }
    else
        return nullptr;
