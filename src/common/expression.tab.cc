...
{
       0,   146,   146,   151,   152,   153,   154,   155,   156,   158,
     159,   161,   166,   168,   170,   172,   174,   176,   179,   196,
     198,   200,   202,   204,   206,   208,   210,   212,   215,   217,
     219,   222,   226,   229,   231,   233,   236,   239,   241,   243,
     248,   253,   258,   260,   262,   267,   269,   274,   276,   281,
     282,   287,   289,   294,   295,   296,   301,   303,   308,   313,
     315,   316,   317,   318,   319,   321,   323,   325,   327,   329,
     331,   333,   335,   337,   342,   344,   349,   351,   356,   357,
     358,   359,   363,   368,   370,   375,   377,   379,   381,   383,
     403,   405,   407,   412,   414,   419,   420,   421,   423
};
#endif
...
#define YYBACKUP(Token, Value)                                    \
  do                                                              \
    if (yychar == YYEMPTY)                                        \
      ...
      {                                                           \
        yyerror (scanner, resultAstTree, YY_("syntax error: cannot back up")); \
        YYERROR;                                                  \
      }                                                           \
  while (0)
  ...
  if (yydebug)                                                            \
    {                                                                     \
      ...
      yy_symbol_print (stderr,                                            \
                  Kind, Value, scanner, resultAstTree); \
      YYFPRINTF (stderr, "\n");                                           \
    }                                                                     \
} while (0)
...
yy_symbol_value_print (FILE *yyo,
                       yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, yyscan_t scanner, AstNode *&resultAstTree)
{
  FILE *yyoutput = yyo;
  YY_USE (yyoutput);
  YY_USE (scanner);
                 ...
                 yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, yyscan_t scanner, AstNode *&resultAstTree)
{
  ...
  yy_symbol_value_print (yyo, yykind, yyvaluep, scanner, resultAstTree);
  YYFPRINTF (yyo, ")");
}
...
yy_reduce_print (yy_state_t *yyssp, YYSTYPE *yyvsp,
                 int yyrule, yyscan_t scanner, AstNode *&resultAstTree)
{
  ...
  for (yyi = 0; yyi < yynrhs; yyi++)
    {
      ...
      yy_symbol_print (stderr,
                       ...
                       &yyvsp[(yyi + 1) - (yynrhs)], scanner, resultAstTree);
      YYFPRINTF (stderr, "\n");
    }
}
...
do {                                    \
  if (yydebug)                          \
    yy_reduce_print (yyssp, yyvsp, Rule, scanner, resultAstTree); \
} while (0)
...
yydestruct (const char *yymsg,
            yysymbol_kind_t yykind, YYSTYPE *yyvaluep, yyscan_t scanner, AstNode *&resultAstTree)
{
  YY_USE (yyvaluep);
  YY_USE (scanner);
  YY_USE (resultAstTree);
...
int
yyparse (yyscan_t scanner, AstNode *&resultAstTree)
{
...
#line 382 "expression.y"
                { (yyval.node) = newConstant(std::numeric_limits<double>::infinity()); }
...
#line 384 "expression.y"
                {
                  ...
                  try {
                      ...
                      d = UnitConversion::parseQuantity((yyvsp[0].str), unit);
                  }
...
yyerrlab:
  ...
  if (!yyerrstatus)
    {
      ++yynerrs;
      yyerror (scanner, resultAstTree, YY_("syntax error"));
    }
      ...
      if (yychar <= YYEOF)
      ...
      else
        {
          yydestruct ("Error: discarding",
                      yytoken, &yylval, scanner, resultAstTree);
          yychar = YYEMPTY;
        }
    }
  ...
  for (;;)
    {
      ...
      yydestruct ("Error: popping",
                  YY_ACCESSING_SYMBOL (yystate), yyvsp, scanner, resultAstTree);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
...
`-----------------------------------------------------------*/
yyexhaustedlab:
  yyerror (scanner, resultAstTree, YY_("memory exhausted"));
  yyresult = 2;
  goto yyreturnlab;
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
                  YY_ACCESSING_SYMBOL (+*yyssp), yyvsp, scanner, resultAstTree);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
