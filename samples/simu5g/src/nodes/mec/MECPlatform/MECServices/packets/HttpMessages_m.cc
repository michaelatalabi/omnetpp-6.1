...
void HttpBaseMessageDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_state: pp->setState((simu5g::HttpRequestState)string2enum(value, "simu5g::HttpRequestState")); break;
        case FIELD_isReceivingMsg: pp->setIsReceivingMsg(string2bool(value)); break;
        case FIELD_type: pp->setType((simu5g::HttpMsgType)string2enum(value, "simu5g::HttpMsgType")); break;
...
void HttpBaseMessageDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    switch (field) {
        ...
        case FIELD_state: pp->setState(static_cast<simu5g::HttpRequestState>(value.intValue())); break;
        case FIELD_isReceivingMsg: pp->setIsReceivingMsg(value.boolValue()); break;
        case FIELD_type: pp->setType(static_cast<simu5g::HttpMsgType>(value.intValue())); break;
