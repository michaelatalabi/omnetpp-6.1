...
const MacNodeId& LteControlInfo::getSourceId() const
{
    return this->sourceId;
}

void LteControlInfo::setSourceId(const MacNodeId& sourceId)
{
    this->sourceId = sourceId;
}

const MacNodeId& LteControlInfo::getDestId() const
{
    return this->destId;
}

void LteControlInfo::setDestId(const MacNodeId& destId)
{
    this->destId = destId;
}
...
const MacNodeId& LteControlInfo::getD2dTxPeerId() const
{
    return this->d2dTxPeerId;
}

void LteControlInfo::setD2dTxPeerId(const MacNodeId& d2dTxPeerId)
{
    this->d2dTxPeerId = d2dTxPeerId;
}

const MacNodeId& LteControlInfo::getD2dRxPeerId() const
{
    return this->d2dRxPeerId;
}

void LteControlInfo::setD2dRxPeerId(const MacNodeId& d2dRxPeerId)
{
...
std::string LteControlInfoDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    LteControlInfo *pp = omnetpp::fromAnyPtr<LteControlInfo>(object); (void)pp;
    switch (field) {
        case FIELD_sourceId: return "";
        case FIELD_destId: return "";
        case FIELD_direction: return enum2string(pp->getDirection(), "simu5g::Direction");
        case FIELD_d2dTxPeerId: return "";
        case FIELD_d2dRxPeerId: return "";
        case FIELD_application: return enum2string(pp->getApplication(), "simu5g::ApplicationType");
        case FIELD_traffic: return enum2string(pp->getTraffic(), "simu5g::LteTrafficClass");
        case FIELD_rlcType: return enum2string(pp->getRlcType(), "simu5g::LteRlcType");
...
omnetpp::cValue LteControlInfoDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    LteControlInfo *pp = omnetpp::fromAnyPtr<LteControlInfo>(object); (void)pp;
    switch (field) {
        case FIELD_sourceId: return omnetpp::toAnyPtr(&pp->getSourceId()); break;
        case FIELD_destId: return omnetpp::toAnyPtr(&pp->getDestId()); break;
        case FIELD_direction: return (omnetpp::intval_t)(pp->getDirection());
        case FIELD_d2dTxPeerId: return omnetpp::toAnyPtr(&pp->getD2dTxPeerId()); break;
        case FIELD_d2dRxPeerId: return omnetpp::toAnyPtr(&pp->getD2dRxPeerId()); break;
...
UserControlInfo_Base::UserControlInfo_Base() : ::simu5g::LteControlInfo()
{
}

UserControlInfo_Base::UserControlInfo_Base(const UserControlInfo_Base& other) : ::simu5g::LteControlInfo(other)
{
    copy(other);
}
...
UserControlInfoDescriptor::UserControlInfoDescriptor() : omnetpp::cClassDescriptor("simu5g::UserControlInfo", "simu5g::LteControlInfo")
{
    propertyNames = nullptr;
}
...
std::string UserControlInfoDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_txMode: return enum2string(pp->getTxMode(), "simu5g::TxMode");
        case FIELD_frameType: return enum2string(pp->getFrameType(), "simu5g::LtePhyFrameType");
