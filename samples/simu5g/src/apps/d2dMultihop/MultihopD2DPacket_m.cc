...
const MacNodeId& MultihopD2DPacket::getSrcId() const
{
    return this->srcId;
}

void MultihopD2DPacket::setSrcId(const MacNodeId& srcId)
{
    handleChange();
    this->srcId = srcId;
}
...
const MacNodeId& MultihopD2DPacket::getLastHopSenderId() const
{
    return this->lastHopSenderId;
}

void MultihopD2DPacket::setLastHopSenderId(const MacNodeId& lastHopSenderId)
{
    handleChange();
...
std::string MultihopD2DPacketDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_lastHopSenderId: return "";
...
omnetpp::cValue MultihopD2DPacketDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    MultihopD2DPacket *pp = omnetpp::fromAnyPtr<MultihopD2DPacket>(object); (void)pp;
    switch (field) {
        case FIELD_srcId: return omnetpp::toAnyPtr(&pp->getSrcId()); break;
        ...
        case FIELD_lastHopSenderId: return omnetpp::toAnyPtr(&pp->getLastHopSenderId()); break;
