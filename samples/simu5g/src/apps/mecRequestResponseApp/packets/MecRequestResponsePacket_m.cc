...
const MacNodeId& MecRequestResponsePacket::getBsId() const
{
    return this->bsId;
}

void MecRequestResponsePacket::setBsId(const MacNodeId& bsId)
{
    handleChange();
    this->bsId = bsId;
}
...
MecRequestResponsePacketDescriptor::MecRequestResponsePacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::MecRequestResponsePacket)), "inet::FieldsChunk")
{
...
omnetpp::cValue MecRequestResponsePacketDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_bsId: return omnetpp::toAnyPtr(&pp->getBsId()); break;
