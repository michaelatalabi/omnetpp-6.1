...
const MacNodeId& LteX2Message_Base::getSourceId() const
{
    return this->sourceId;
}

void LteX2Message_Base::setSourceId(const MacNodeId& sourceId)
{
    handleChange();
    this->sourceId = sourceId;
}

const MacNodeId& LteX2Message_Base::getDestinationId() const
{
    return this->destinationId;
}

void LteX2Message_Base::setDestinationId(const MacNodeId& destinationId)
{
    handleChange();
...
LteX2MessageDescriptor::LteX2MessageDescriptor() : omnetpp::cClassDescriptor("simu5g::LteX2Message", "inet::FieldsChunk")
{
...
std::string LteX2MessageDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_destinationId: return "";
        default: return "";
    }
}
...
omnetpp::cValue LteX2MessageDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_destinationId: return omnetpp::toAnyPtr(&pp->getDestinationId()); break;
